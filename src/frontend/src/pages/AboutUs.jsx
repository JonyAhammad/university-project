...
import { Linkedin, Twitter, Github, Globe, Mail, Heart, MapPin, Calendar, Users, GraduationCap } from 'lucide-react';
        ...
        <div className="bg-teal-600 py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-teal-100 text-center mt-4 max-w-3xl mx-auto">
              Our mission is to create a world where no child goes hungry, 
              by connecting communities and resources through innovative technology.
            </p>
          </div>
        </div>
        {/* Mission Section */}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-10">
                ...
                <p className="text-gray-700 mb-6">
                  NourishNet's mission is to create a transparent and efficient global platform 
                  that connects children in need with food providers and donors, ensuring that 
                  every child has access to nutritious meals regardless of their circumstances.
                </p>
                <h3 className="text-xl font-semibold text-teal-700 mb-4">Our Vision</h3>
                <p className="text-gray-700">
                  We envision a world where childhood hunger is eliminated through community-driven 
                  support networks, powered by transparent technology that builds trust and enables 
                  direct connections between those who can help and those in need.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  <div className="text-teal-600 text-2xl font-bold mb-2">100+</div>
                  <div className="text-gray-800 font-medium">Communities Served</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  <div className="text-teal-600 text-2xl font-bold mb-2">50,000+</div>
                  <div className="text-gray-800 font-medium">Children Supported</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  <div className="text-teal-600 text-2xl font-bold mb-2">25</div>
                  <div className="text-gray-800 font-medium">Countries Reached</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {foundersData.map((founder, index) => <div key={founder.id} ref={el => addToFoundersRef(el, index)} className={`bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 ${location.state?.highlightFounderId === founder.id ? 'ring-2 ring-teal-500' : ''}`}>
                  ...
                  <div className="p-6">
                    ...
                    {founder.education && <div className="flex items-center text-gray-600 mb-4">
                        <GraduationCap size={16} className="mr-2 text-teal-600" />
              ...
              <div className="space-y-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">The Beginning</h3>
                    <p className="text-gray-700">
                      Our founders met while working on humanitarian projects across different continents. 
                      Witnessing firsthand the inefficiencies in food aid distribution, they envisioned 
                      a platform that could directly connect donors with children in need.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Platform Launch</h3>
                    <p className="text-gray-700">
                      NourishNet launched as a pilot program in three countries, focusing on creating 
                      a transparent system where donors could see exactly how their contributions were 
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Global Expansion</h3>
                    <p className="text-gray-700">
                      Following initial success, NourishNet expanded to 15 more countries, building 
                      local partnerships with food providers and establishing community verification 
                      networks to ensure support reached those who needed it most.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Building for the Future</h3>
                    <p className="text-gray-700">
                      Today, NourishNet continues to innovate with new features like local support networks, 
                      real-time donation tracking, and community-driven verification systems. Our goal is to 
                      create sustainable food support ecosystems in every community we serve.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/become-donor" className="bg-teal-600 text-white px-6 py-3 rounded-md font-medium hover:bg-teal-700 transition-colors">
                  Become a Donor
                </Link>
                <Link to="/volunteer-registration" className="bg-white text-teal-700 border border-teal-600 px-6 py-3 rounded-md font-medium hover:bg-teal-50 transition-colors">
                  Volunteer With Us
                </Link>
                <Link to="/join-our-mission" className="bg-teal-100 text-teal-700 px-6 py-3 rounded-md font-medium hover:bg-teal-200 transition-colors">
                  Learn More
                </Link>
              </div>
            </div>
