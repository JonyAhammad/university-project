      ...
      <main className="flex-grow">
        <div className="bg-red-600 py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-red-100 text-center mt-2 max-w-3xl mx-auto">
              Understanding the scale and impact of childhood hunger around the
              world and how we can work together to solve it.
            </p>
          </div>
        </div>
        {/* Key Statistics */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-red-50 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-700">
                  Children with stunted growth due to malnutrition
                </p>
              </div>
              <div className="bg-red-50 p-6 rounded-lg text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-red-100 rounded-full mb-4">
                ...
                <p className="text-gray-700">
                  Of child deaths linked to undernutrition
                </p>
              </div>
            </div>
            <div className="mt-12 text-center text-gray-600">
              <p className="max-w-3xl mx-auto">
                Source: United Nations World Food Programme and UNICEF data,
                2022
              </p>
            </div>
          </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
              Childhood hunger affects every region of the world, but some areas
              face more severe challenges due to conflict, climate change, and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Home to the highest rates of childhood hunger, with 1 in 3
                    children experiencing malnutrition. Drought, conflict, and
                    poverty are major contributing factors.
                  </p>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Despite economic growth, millions of children still suffer
                    from malnutrition. Climate events and economic inequality
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Conflict and displacement have dramatically increased food
                    insecurity. Children in Yemen, Syria, and parts of Iraq face
                    acute malnutrition.
                  </p>
                  <ul className="list-disc pl-5 text-gray-600 mb-4">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Economic crises and climate events have reversed progress on
                    food security. Venezuela, Haiti, and parts of Central
                    America face significant challenges.
                  </p>
                  <ul className="list-disc pl-5 text-gray-600 mb-4">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Progress has been made, but pockets of severe malnutrition
                    persist in remote areas and among marginalized communities.
                  </p>
                  <ul className="list-disc pl-5 text-gray-600 mb-4">
                    ...
                    <li>
                      Climate change increasingly threatening food security
                    </li>
                  </ul>
                  <div className="flex items-center text-yellow-500">
                    <Info size={16} className="mr-2" />
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Even in wealthy nations, food insecurity affects millions of
                    children, particularly in underserved communities and during
                    economic downturns.
                  </p>
                  <ul className="list-disc pl-5 text-gray-600 mb-4">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
              Childhood hunger has far-reaching consequences that extend beyond
              immediate physical discomfort, affecting every aspect of a child's
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  <li>
                    66% lower school attendance rates among hungry children
                  </li>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  <li>
                    Weakened immune systems and increased vulnerability to
                    disease
                  </li>
                  <li>Stunted physical growth and development</li>
                  <li>
                    Micronutrient deficiencies leading to lifelong health issues
                  </li>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  ...
                  <li>
                    Behavioral issues and difficulty forming relationships
                  </li>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  ...
                  <li>
                    Potential for social unrest in severely affected areas
                  </li>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  <li>
                    Undermines progress on all Sustainable Development Goals
                  </li>
        ...
        <section className="py-16 bg-teal-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
              Solving childhood hunger requires coordinated efforts at all
              levels. Here's how NourishNet and supporters like you can make a
              difference.
            </p>
                ...
                <ul className="space-y-4">
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Providing immediate meals and nutrition to children in
                        crisis situations through our verified partners.
                      </p>
                    </div>
                  </li>
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Implementing sustainable meal programs in schools to
                  ...
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Distributing essential vitamins and supplements to
                  ...
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Supporting local kitchens that provide nutritious meals
                ...
                <ul className="space-y-4">
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Teaching sustainable farming techniques to communities
                  ...
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Providing knowledge about balanced diets and optimal
                        child nutrition to families and caregivers.
                      </p>
                    </div>
                  </li>
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Supporting parents and communities with skills training
                  ...
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Working with governments and organizations to implement
                        effective anti-hunger policies.
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Support our efforts with one-time or recurring donations
                    that directly fund food programs for children.
                  </p>
                  <a
                    href="/become-donor"
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Join our global network of volunteers who help distribute
                    food, teach nutrition, and support communities.
                  </p>
                  <a
                    href="/contact"
                    className="inline-block bg-teal-600 text-white px-4 py-2 rounded-md text-sm hover:bg-teal-700 transition-colors"
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Share information about childhood hunger and our solutions
                    with your network to expand our reach.
                  </p>
        ...
        <section className="py-16 bg-red-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-red-100 max-w-3xl mx-auto mb-8">
              Every child deserves to grow up healthy, strong, and
              well-nourished. Join us in our mission to end childhood hunger
              worldwide.
            </p>
            <div className="flex flex-col md:flex-row justify-center gap-4">
              <a
                href="/become-donor"
                className="bg-white text-red-700 px-8 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors"
              >
                Donate Now
              </a>
              <a
                href="/track-donation"
                className="bg-red-800 text-white px-8 py-3 rounded-md font-medium hover:bg-red-900 transition-colors"
              >
                Track Your Impact
              </a>
              <a
                href="/verification-center"
                className="border border-white text-white px-8 py-3 rounded-md font-medium hover:bg-red-700 transition-colors"
              >
                Get Verified
              </a>
            </div>
